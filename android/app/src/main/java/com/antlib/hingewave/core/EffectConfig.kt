...
data class LaptopConfig(val startAngle: Double, val endAngle: Double, val armVelocity: Double)
...
data class EffectConfig(
    ...
    companion object {
        ...
        val DEFAULTS = EffectConfig(
            ...
            stillSeconds = 2.0,
            clearSeconds = 0.6,
            laptop = LaptopConfig(startAngle = 90.0, endAngle = 8.0, armVelocity = 15.0),
            phone = PhoneConfig(
                deadZone = 6.0,
        ...
        fun fromJson(text: String): EffectConfig {
            ...
            return EffectConfig(
                ...
                laptop = LaptopConfig(lp.getDouble("startAngle"), lp.getDouble("endAngle"), lp.getDouble("armVelocity")),
                phone = PhoneConfig(
